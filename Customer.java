...
public class Customer implements Serializable
{
	...
	// we need to check if the wishlist is full first and then proceed:
		if (n == 20)
		{
		...
		else
		{
			...
			{
				System.out.println(x.getTitle() + " is unfortunately no longer availble.");
			}
		}
	}
	...
	public void printWatched() { //prints all movies customer has watched
		...
		while (current!= null) { //printing each watched movie and going through the list
